...
export default function CreateUV() {
    ...
    const [diaDiem, setdiaDiem] = useState(['rất xa(lớn hơn 8km)','xa(5km ~ 8km)', 'vừa(2km ~ 5km)', 'gần(500m ~ 2km)','rất gần(~500m)'])
    ...
    return (
        <div id="tao-ung-vien">
            ...
            <br />
            <label>Ngày sinh:</label><input placeholder="Nhập ngày sinh" value={dateOfBirth} type="date" onChange={(e)=>setDateOfBirth(e.target.value)} />
            <br />
